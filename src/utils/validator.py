...
class Validator:
    ...
    def directory(
        ...
        if self._check_string(error_msg_base, dir_path):
    ...
    def filename(
        ...
        if self._check_string(error_msg_base, filename):
    ...
    def url(
        ...
        if self._check_string(error_msg_base, url):
    ...
    def api_token(
        ...
        if self._check_string(error_msg_base, token_value):
